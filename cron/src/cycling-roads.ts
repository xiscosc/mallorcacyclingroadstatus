 ...
 */
export const CYCLING_ROADS: readonly string[] = [
	// ───── Tramuntana core ─────
	...
	// ───── Tramuntana south-west (Andratx / Palma side) ─────
	...
	// ───── North coast feeders (312 course) ─────
	...
	// ───── Migjorn / South-east (Felanitx, Santanyí) ─────
	...
	// ───── South / Migjorn (Llucmajor, Campos, Santanyí coast) ─────
